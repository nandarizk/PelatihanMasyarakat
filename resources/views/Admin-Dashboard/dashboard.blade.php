...
<body class="bg-[#FAF9F5] font-sans antialiased text-gray-800 flex h-screen overflow-hidden relative">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <main class="p-4 sm:p-6 md:p-8 flex-1">
            ...
            <!-- Top Navigation Bar -->
            <div class="flex justify-between md:justify-end items-center gap-6 mb-6 text-gray-600 text-sm">
                <!-- Tombol Hamburger Mobile -->
                <button onclick="toggleSidebar()" class="md:hidden p-2 text-gray-700 hover:text-emerald-800 rounded-lg bg-white border border-gray-200">
            ...
            <div class="mb-6 sm:mb-8">
                <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Selamat Datang, Admin</h2>
                <p class="text-gray-500 text-xs sm:text-sm">Kelola data masyarakat dan kesempatan kerja.</p>
            </div>

            <!-- Stat Cards Grid (Responsive 1 -> 2 -> 4 Kolom) -->
            ...
            <!-- Middle Section (Responsive Stack -> 2 Kolom) -->
            ...
            <!-- Bottom Section (Responsive Stack -> 12 Kolom Desktop) -->
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                <!-- Rekomendasi Terbaru -->
                <div class="lg:col-span-4 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                            ...
                            <button class="w-8 h-8 rounded-full bg-[#0B5C3D] text-white flex items-center justify-center text-xs shrink-0">
                ...
                <!-- Masyarakat Terbaru -->
                <div class="lg:col-span-8 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
